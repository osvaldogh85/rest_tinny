...
public class PutCall extends Call {

    private final String serverURL;
    private final String requestMethodURL;
    private final String JSONBodyContent;

    private PutCall(String serverURL, String requestMethodPath, String JSONBodyContent, String apiToken) {
    ...
    public static ICall build(String serverURL, String requestMethodPath, String JSONBodyContent, String apiToken) {
        return new PutCall(serverURL, requestMethodPath, JSONBodyContent, apiToken);
    }

    private PutCall(String serverURL, String requestMethodPath, String JSONBodyContent, String user, String password) {
    ...
    public static ICall build(String serverURL, String requestMethodPath, String JSONBodyContent, String user, String password) {
        return new PutCall(serverURL, requestMethodPath, JSONBodyContent, user, password);
    }
